...
contract ICOMHC is IERC20{
     ...
     //set price of token , 0.0007 ether = 
     uint public tokenprice = 700000000000000;

     //hardcap 2850 ether = 2850000000000000000000
     uint public icotarget = 2850000000000000000000;

     //define a state variable to track the funded amount
     uint public recievedFund;

     //maximum (2 ether) & minimum (0.001) investment allowed
     ...
     uint public icoEndTime = now + 30;
     //trading start time
     uint public startTrading = icoEndTime + 30;
     ...
     function Investing() payable public returns(bool){
         ...
         //check for minimum and maxiumum investment
